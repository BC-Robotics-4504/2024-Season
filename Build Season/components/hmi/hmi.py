...
class HMIModule:
    ...
    def getAnalogs(self):
        return self.hmi_interface.XboxController.getLeftX, self.hmi_interface.XboxController.getLeftY, self.hmi_interface.XboxController.getRightX, self.hmi_interface.XboxController.getRightY
